...
class SignatureMethod_RSA_SHA1(oauth.SignatureMethod):
    ...
    def sign(self, request, consumer, token):
        ...
        with open( Path.home() / 'Desktop/1/.oauthconfig/oauth.pem', 'r') as f:
            data = f.read()
...
def get_jira_oauth_init_parameters():
    ...
    starter_oauth_config_file = Path.home() / "Desktop/1/.oauthconfig/starter_oauth.config"
    ...
    rsa_public_key = None
    with open ( Path.home() / 'Desktop/1/.oauthconfig/oauth.pub', 'r') as key_cert_file:
